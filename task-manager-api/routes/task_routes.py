"""Routes de Task — apenas mapeamento HTTP → controller."""
...
task_bp.add_url_rule(
    "/tasks/<int:task_id>", view_func=task_controller.update_task, methods=["PUT"]
)
task_bp.add_url_rule(
    "/tasks/<int:task_id>", view_func=task_controller.delete_task, methods=["DELETE"]
)
